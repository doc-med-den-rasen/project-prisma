...
def parse_pflegeplan_xlsx_v08(xlsx_path: str | Path) -> tuple[list[dict[str, Any]], dict[str, Any]]:
...
if __name__ == "__main__":
    print("Dies ist der Parser v08 von PRISMA.")
    print("Bitte starte die Streamlit-Oberfläche: prisma_app_v08.py")
